          ...
          <div className="columns">
            ...
            <div className="columns is-3">
              ...
              <ProfileCard
                ...
                handle="@cortana32"
                image={CortanaImage}
                description="Cortana was made buy Microsoft. Who knows what it does"
              />
            </div>
            <div className="columns is-3">
              {" "}
              <ProfileCard title="Siri" handle="@siri01" image={SiriImage} description="Siri was made by Apple and us being phased out"/>
            </div>
          </div>
        </section>
      </div>
